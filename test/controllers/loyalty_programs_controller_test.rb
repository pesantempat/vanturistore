...
class LoyaltyProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loyalty_program" do
    assert_difference('LoyaltyProgram.count') do
      post loyalty_programs_url, params: { loyalty_program: { end_loyalty: @loyalty_program.end_loyalty, keterangan_loyalty: @loyalty_program.keterangan_loyalty, point_customer: @loyalty_program.point_customer, point_loyalty: @loyalty_program.point_loyalty, reward_id: @loyalty_program.reward_id, start_loyalty: @loyalty_program.start_loyalty, status_loyalty: @loyalty_program.status_loyalty } }
    end
  ...
  test "should update loyalty_program" do
    patch loyalty_program_url(@loyalty_program), params: { loyalty_program: { end_loyalty: @loyalty_program.end_loyalty, keterangan_loyalty: @loyalty_program.keterangan_loyalty, point_customer: @loyalty_program.point_customer, point_loyalty: @loyalty_program.point_loyalty, reward_id: @loyalty_program.reward_id, start_loyalty: @loyalty_program.start_loyalty, status_loyalty: @loyalty_program.status_loyalty } }
